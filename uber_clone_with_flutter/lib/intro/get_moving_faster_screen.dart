...
import 'package:uber_clone/intro/agree_terms_and_conditions.dart';
...
class GetMovingFasterScreen extends StatelessWidget {
              ...
              child: IconButton(
                  ...
                  onPressed: () {
                    navigateWithAnimationWithBackStack(
                        PersonalInformationSection(), context);
                  }),
            ),
            Positioned(
              left: size.width / 5,
  ...
  void _navigateToNextScreen(BuildContext context) {
    ...
    Future.delayed(Duration(seconds: 3), () {
      ...
      navigateWithAnimationWithBackStack(AgreeTermsAndConditions(), context);
    });
  }
}
